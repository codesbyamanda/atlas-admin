...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:block fixed left-0 top-0 z-40 h-screen w-64 border-r border-border/50 bg-background/80 backdrop-blur-xl">
      {/* Logo / Brand */}
